...
import { MortgageBreakdownChart, type YearlyChartData } from './components/MortgageBreakdownChart'
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[320px_1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 sm:p-5">
              ...
              <MortgageBreakdownChart data={yearlyChartData} formatCurrency={euroFormatter.format} />
            </div>
          </div>
        </div>
      </section>
